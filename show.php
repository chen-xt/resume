    ...
    <style type="text/css">
        ...
        *{
        ...
        .login-box{
            ...
            background:url(images/mask.png);border-radius:10px;height: 440px;
        }
        table tr td{
        ...
        .button{
            ...
            text-shadow:0 1px 2px rgba(0,0,0,.1);float: right;margin-left: 100px;
        }
    </style>
...
<div class="login-box">
    ...
    <table class="left">
        ...
        <tr class="t1">
            <td style="width: 40px;"><label>头  像：</label></td>
        </tr>
        <tr class="t1">
