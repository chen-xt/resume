...
<head>
    ...
    <style type="text/css">
        ...
        ;}
        body{
            font-family:Microsoft YaHei,Segoe UI,Tahoma,Arial,Verdana,sans-serif;font-size:12px;
            color:#fff;height:100%;line-height:1;background:#999;
        }
        *{
            margin:0;padding:0;
        }
        ...
        button{
            cursor:pointer;width:100%;height:44px;padding:0;background:#ef4300;border:1px solid #ff730e;
            border-radius:6px;font-weight:700;color:#fff;font-size:24px;letter-spacing:15px;text-shadow:0 1px 2px rgba(0,0,0,.1);
        }
        input:focus{
        ...
        .screenbg a img{
            vertical-align:middle;display:inline;border:none;display:block;list-style:none;position:fixed;overflow:hidden;top:0;
            left:0;width:100%;height:100%;z-index:-1000;float:right;
        }
        .reg{
            margin-top: 10px;
            margin-left: 250px;;
...
<div class="login-box">
    ...
    <form action="login_select.php" method="post">
        <div class="name">
            <label>用户名：</label>
            <input type="text" name="user_name" placehoder="输入用户名" tabindex="1" autocomplete="off" />
        </div>
        <div class="password">
            <label>密  码：</label>
            <input type="password" name="pwd" placehoder="输入密码" maxlength="16" id="" tabindex="2"/>
        </div><br/>
        <div class="login">
            <button type="submit" tabindex="5">登录</button>
        </div>
        <div class="reg">
            <a href="reg.php">如果还未注册，请先注册！</a>
        </div>
    </form>
</div>
<div class="screenbg">
