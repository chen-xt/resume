...
<head>
    ...
    <style type="text/css">
        ...
        *{
        ...
        .login-box .password, .login-box .name,.login-box .sex,.login-box .age,.login-box .tel,.login-box .photo,.login-box .job{
...
<div class="login-box">
    <h1>修改信息</h1>
    <form action="update_msg.php" enctype="multipart/form-data" method="post">
        <div class="name">
            <label>用户名：</label>
            <input type="text" name="user_name" tabindex="1" autocomplete="off"  value="<?php echo $name; ?>" />
        </div>
        <input type="hidden" name="id" value="<?php echo $name=isset($_GET['id'])?$_GET['id']:''; ?>"/>
        <div class="password">
            <label>密  码：</label>
        ...
        <br/><div class="post">
            <button type="submit" tabindex="5">修改</button>
        </div>
    </form>
</div>
<div class="screenbg">
